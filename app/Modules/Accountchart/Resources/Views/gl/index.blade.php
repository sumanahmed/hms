        ...
        <div class="md-card-content">
            <div class="uk-overflow-container uk-margin-bottom">
                ...
                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                    ...
                    <tbody>
                    <?php $count = 1; ?>
                    @foreach($accountgl as $account)
                    <tr>
                        <td>{{ $count++ }}</td>
                        <td>{{ $account->account_name }}</td>
                        <td>{{ $account->account_type_account_name }}</td>
                        <td class="uk-text-center">
                            <a href="{{ route('account_gl_edit',['id' => $account->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
    ...
    <script>
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "/account-chart/account-gl-delete/"+id;
            })
        })
    </script>
