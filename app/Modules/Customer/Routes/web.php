...
Route::group(['prefix' => 'customer','middleware' => 'auth'], function () {
    ...
    Route::get('recruit/report_pdf/{id}', 'WebController@report_pdf')->name('customer_report_pdf')->middleware('read_access');
    Route::get('recruit/download_report_pdf/{id}', 'WebController@download_report_pdf')->name('customer_download_report_pdf')->middleware('read_access');
...
Route::group(['prefix' => 'customer/information','middleware' => 'auth'], function () {
    Route::get('subreference/autosuggest', 'information\WebController@autosuggest')->name('customer_subreference_autosuggest')->middleware('read_access');
