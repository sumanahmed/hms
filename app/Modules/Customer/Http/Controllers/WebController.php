...
class WebController extends Controller
{
    ...
    public function report_pdf($id)
    {
        ...
        return view('customer::report_pdf',compact('flight','id','recruit_order','totalamount','payment_entry','expense'));
    }
    ...
    public function download_report_pdf($id)
    {
      ...
      $recruitexpensepax = $recruitexpensepax->unique('recruitExpenseid');
        ...
        return view('customer::customer_report_pdf_page',compact('flight','id','recruit_order','totalamount','payment_entry','expense','id','payment_entry','totalamount','recruitexpensepax'));
    }
    
    //  public function download_customer_report_pdf($id)
    // {
    //      $Rorder=Recruitorder::where('paxid',$id)->first();
    ...
    //     return view('customer::customer_report_pdf_page',compact('flight','id','recruit_order','totalamount','payment_entry','expense'));
    // }
