            ...
            <div class="md-card-content">
                ...
                <div class="uk-overflow-container">
                    <table class="uk-table">
                        ...
                        @if(isset($recruit_order->mofas) && count($recruit_order->mofas['mofa_file']))
                        ...
                        @if(isset($recruit_order->fitcard) && count($recruit_order->fitcard['fit_card_file']))
                        ...
                        @if(isset($recruit_order->police) && count($recruit_order->police['policeClearanceFile']))
                        ...
                        @if(isset($recruit_order->visa) && count($recruit_order->visa))
                            <tr>
                        ...
                        @if(isset($recruit_order->finger) && count($recruit_order->finger['fingerPrintfile']))
                        ...
                        @if(isset($recruit_order->training) && count($recruit_order->training['trainingFile']))
                        ...
                        @if(isset($recruit_order->completion) && count($recruit_order->completion['completionFile']))
                        ...
                        @if(isset($recruit_order->submission) && count($recruit_order->submission['submition_file']))
                        ...
                        @if(isset($recruit_order->confirmation) && count($recruit_order->confirmation['confirmationFile']))
                        ...
                        @if(isset($recruit_order->confirmation) && isset($recruit_order->iqamaReceive) && count($recruit_order->iqamaReceive))
                            <tr>
