                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="returnflightarrivaliataDate">IATA Submit Date<span style="color: red">*</span></label>
                                        </div>
                                        <div class="uk-width-medium-2-5">

                                            <label for="returnflightarrivaliataDate">IATA Submit Date</label>
                                            <input class="md-input" type="text" id="iataDate" name="iataDate" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{ $refund->iata_submit_date }}" required/>
                                            @if($errors->has('iataDate'))
                                                <div class="uk-text-danger">{{ $errors->first('iataDate') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-width-1-1" >
                                            <div class="uk-grid">
                                                ...
                                                <div class="uk-width-medium-2-5">
                                                    ...
                                                    <select {{ $refund->bill?'disabled':"" }}  name="bill_particular" id="bill_item" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select Item">
                                                        <option value="" disabled selected hidden>Select...</option>
                                                        @foreach($item as $value)
                                                            @if($refund->bill)
