                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                                ...
                                                <div class="uk-margin-top" style="padding-bottom: 20px;">
                                                    ...
                                                    <div class="uk-grid" data-uk-grid-margin>
                                                        ...
                                                        <div class="uk-width-medium-5-10">
                                                            <input class="md-input" type="text" id="vat_adjust" ng-model="vat_adjust" onkeypress="numbervalidate()"  name="vat_adjust" value="{{$payment_receive->vat_adjustment}}" ng-init="vat_adjust=0" ng-readonly="truefalse" ng-keyup="vat()" />
                                                    ...
                                                    <div class="uk-grid" data-uk-grid-margin>
                                                        ...
                                                        <div class="uk-width-medium-5-10">
                                                            <input class="md-input" type="text" id="tax_adjust" ng-model="tax_adjust" name="tax_adjust" onkeypress="numbervalidate()"  value="{{$payment_receive->tax_adjustment}}" ng-init="tax_adjust=0" ng-readonly="truefalse" ng-keyup="tax()" />
                                                    ...
                                                    <div class="uk-grid" data-uk-grid-margin>
                                                        ...
                                                        <div class="uk-width-medium-5-10">
                                                            <input class="md-input" type="text" id="other_adjust" ng-model="other_adjust" name="other_adjust" onkeypress="numbervalidate()" value="{{$payment_receive->others_adjustment}}" ng-init="other_adjust=0" ng-readonly="truefalse" ng-keyup="other()" />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="deposite_to">Deposit To</label>
                                        </div>
                                        ...
                                        <div class="uk-width-medium-1-5" id="show">
                                            <input type="checkbox"
                                                   @if($payment_receive->invoice_show == "on")
                                                   checked="checked"
                                                   @endif
                                                   id="invoice_show" name="invoice_show" />
                                            <label for="switch_demo_1" class="inline-label" id="show_invoice">Show</label>
