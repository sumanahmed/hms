                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update Special Offer</span></h2>
                            </div>
                        </div>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" id="company_id" name="company_id" data-md-selectize >
                                            @foreach($company as $value)
                                                <option value="{{ $value->id }}" @if($special_offer->company_id == $value->id) selected @endif>{{ $value->display_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" id="sku_id" name="sku_id" data-md-selectize >
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" @if($special_offer->sku_id == $product->id) selected @endif>{{ $product->product_code." ".$product->item_name }}</option>
                                            @endforeach
                                        </select>
