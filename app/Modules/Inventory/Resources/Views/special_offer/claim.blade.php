...
@section('title', 'Special Offer Claim')
...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile"
        ...
        <div class="uk-width-large-10-10" ng-controller="ContactController">
            {{--{!! Form::open(['url' => route('special_offer_update', $special_offer->id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}--}}
                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Claim</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="from_date" name="from_date" value="{{ date("d-m-Y",strtotime($special_offer->from_date)) }}" data-uk-datepicker="{format:'DD-MM-YYYY'}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="to_date" name="to_date" value="{{ date("d-m-Y",strtotime($special_offer->to_date)) }}" data-uk-datepicker="{format:'DD-MM-YYYY'}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="company_id">Name <span style="color: red;" class="asterisc">*</span> </label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" id="company_id" name="company_id" data-md-selectize >
                                            @foreach($company as $value)
                                                <option value="{{ $value->id }}" @if($special_offer->company_id == $value->id) selected @endif>{{ $value->company_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" id="sku_id" name="sku_id" data-md-selectize >
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" @if($special_offer->sku_id == $product->id) selected @endif>{{ $product->product_code }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="sku_qty" name="sku_qty" value="{{ $special_offer->sku_qty }}"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" id="free_sku_id" name="free_sku_id" data-md-selectize >
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" @if($special_offer->free_sku_id == $product->id) selected @endif>{{ $product->product_code }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="free_sku_qty" name="free_sku_qty" value="{{ $special_offer->free_sku_qty }}"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="free_sku_qty">Total Purchase <span style="color: red;" class="asterisc">*</span> </label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="free_sku_qty" name="free_sku_qty" value=" "/>
                                        @if($errors->has('free_sku_qty'))
                                            <div class="uk-text-danger uk-margin-top">{{ $errors->first('free_sku_qty') }}</div>
                                        @endif
                                    </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="free_sku_qty">Claim Quantity <span style="color: red;" class="asterisc">*</span> </label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="free_sku_qty" name="free_sku_qty" value=" "/>
                                        @if($errors->has('free_sku_qty'))
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="free_sku_qty">Claim Value <span style="color: red;" class="asterisc">*</span> </label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="free_sku_qty" name="free_sku_qty" value=" "/>
                                        @if($errors->has('free_sku_qty'))
