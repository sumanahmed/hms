                                ...
                                {!! Form::open(['url' => route('inventory_category_update', ['id' => $category->id]), 'method' => 'POST']) !!}
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label for="item_category_name">@lang('trans.category_name_eng')</label>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label for="item_category_description" class="uk-vertical-align-middle">@lang('trans.description')(En)</label>
                                        </div>
                                        <div class="uk-width-medium-4-5">
                                            <label for="item_category_description">@lang('trans.category_description_eng')</label>
