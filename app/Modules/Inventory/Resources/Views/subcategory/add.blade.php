                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">@lang('trans.sub_category_create')</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('inventory_sub_category_store'), 'method' => 'POST']) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="item_sub_category_name" name="item_sub_category_name" required/>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        ...
                                        <textarea class="md-input" name="item_sub_category_description" id="item_sub_category_description" cols="30" rows="4" required></textarea>
                                    </div>
                                </div>
