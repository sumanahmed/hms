...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('inventory_update', $item->id), 'method' => 'post', 'enctype'=>'multipart/form-data', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update Product</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="entry_date" name="entry_date" value="{{ date("d-m-Y",strtotime($item->entry_date)) }}" data-uk-datepicker="{format:'DD-MM-YYYY'}">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="product_code" name="product_code" value="{{ $item->product_code }}" required readonly/>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="form-control" id="company_id" name="company_id">
                                            @foreach($comapny as $value)
                                                <option value="{{ $value->id }}" @if( $value->id == $item->id) selected @endif>{{ $value->display_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="curtoon_size" name="curtoon_size"  value="{{ $item->curtoon_size }}" required/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="unit_type" name="unit_type" value="{{ $item->unit_type }}" required/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <textarea class="md-input" name="note" id="note" cols="30" rows="4">{{ $item->note }}</textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <img src="{{ asset($item->image) }}" style="width:100px;height: 80px;" />
                                    </div>
                                </div>

                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="image">Updae New Image</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
