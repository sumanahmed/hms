                            ...
                            <div class="uk-width-1-1">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-table-middle">
                                        <td class="uk-text-left"><a href="{{route('bank_report_details',[$bank_names_data->account_name_id,$start,$end])}}">{{ $Bankreport->contact($bank_names_data->account_name_id) }}</a></td>
                                        <td class="uk-text-right" title="{{ $bank_names_data->account_name_id }}">
                                            {{ $Bankreport->deposit_openning_balance($bank_names_data->account_name_id)-$Bankreport->withdraw_openning_balance($bank_names_data->account_name_id) }}
                                        </td>
                                        <td class="uk-text-right" title="{{ $bank_names_data->account_name_id }}">
                                        ...
                                        <td class="uk-text-right">{{ $Bankreport->deposit($bank_names_data->account_name_id) - $Bankreport->withdraw($bank_names_data->account_name_id) }}</td>
                                    </tr>
                                    @endforeach
