...
@endif
    ...
    <div class="uk-width-medium-10-10 uk-container-center reset-print" >
                           ...
                           @if($theader->getBanner()->headerType)
                            ...
                            @else
                                <div class="uk-grid" data-uk-grid-margin style="text-align: center; margin-top:50px;">
                                    <h1 style="width: 100%; text-align: center;"><img style="text-align: center;" class="logo_regular" src="{{ url('uploads/op-logo/logo.png') }}" alt="{{ $OrganizationProfile->company_name }}" height="15" width="71"/> {{ $OrganizationProfile->company_name }}</h1>
                                </div>
                                <div class="" style="text-align: center;">
                           ...
                           @endif
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-5-5" style="font-size: 12px;">
                                    <div class="uk-grid">
                                        <h2 style="text-align: center; width: 90%;" class="" onload="func()" id="alertt">
                                    ...
                                    <div class="uk-margin-bottom">
                                        ...
                                        <address>
                                            ...
                                            <p>
                                                ...
                                                @if($invoice->customer->billing_street || $invoice->customer->billing_city || $invoice->customer->billing_state || $invoice->customer->billing_zip_code || $invoice->customer->billing_country)
                                                  <b>Billing Address- </b>
                                            ...
                                            <p>
                                              @if($invoice->customer->shipping_street || $invoice->customer->shipping_city || $invoice->customer->shipping_state || $invoice->customer->shipping_zip_code || $invoice->customer->shipping_country)
                                    ...
                                    <table id="info" class="uk-table inv_top_right_table">
                                     ...
                                     @endif
                                       ...
                                       @if(isset($invoice->Ticket))
                                        ...
                                        <tr>
                                         <td class="uk-text-left " style="word-wrap: break-word"> Passenger Name</td>
                                          <td class="uk-text-center ">{{ $invoice->Recruit['passenger_name'] }}</td>
                                        </tr>
                                        @elseif(isset($invoice->ticketRefund))
                                        <tr style="white-space:nowrap; line-height: 10px;">
                                            <td > Passenger Name</td>
                                            <td style="white-space:nowrap; text-align: center">{{ $invoice->ticketRefund['first_name'].' '.$invoice->ticketRefund['last_name'] }}</td>
                                        </tr>

                                        <tr >
                                         <td class="uk-text-left " style="word-wrap: break-word"> Ticket Number</td>
                                         <td class="uk-text-center ">{{ $invoice->ticketRefund['ticket_number'] }}</td>
                                        </tr>
                                        @else
                                               <tr>
                                ...
                                <div class="uk-width-1-1">
                                    <table id="table_center" border="1" class="uk-table"  >
                                        ...
                                        <tr class="uk-text-upper">
                                            <th>#</th>
                                            <th class="uk-text-center">Products/Services</th>
                                        ...
                                        <tr class="uk-table-middle">
                                            ...
                                            <td>{!! nl2br($invoice_entry['description']) !!}</td>
                                        ...
                                        <tr class="uk-table-middle">
                                            ...
                                            <td class=""></td>
                                            @if($invoice_discount_count>0)<td class=""></td>@endif
                                            <td class="uk-text-center ">Others Adjustment</td>
                                        ...
                                        <tr class="uk-table-middle">
                                            ...
                                            <td class="uk-text-center " style="background: #efefef">BDT {{ ($invoice->total_amount - ($invoice->vat_adjustment + $invoice->tax_adjustment + $invoice->others_adjustment + $invoice->due_amount)) }}</td>
                                        </tr>
                                        ...
                                        <tr class="uk-table-middle">
                                            ...
                                            <td class="uk-text-center " style="background: #efefef">BDT {{ $invoice->due_amount }}</td>
                                        </tr>
                            ...
                            <div class="uk-grid uk-margin-large-bottom">
                                <div class="uk-width-1-1">
                                    ...
                                    <span class="uk-text-muted uk-text-small uk-text-italic">Notes: <span class="uk-text-small">{{$invoice->customer_note}}</span></span>
                            ...
                            <div class="uk-grid">
                             ...
                             <div class="uk-grid">
                                <div class="uk-width-1-2">
                                    <p class="uk-text-small uk-margin-bottom">We look forward to working with you in the future.</p>
        ...
        <!-- Multiple Due Date Modal -->
        <div style="margin-top: 100px;height: auto" class="modal fade" id="multipleDueDate" tabindex="-1" role="dialog" aria-labelledby="multipleDueDateLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div style="border-bottom: none" class="modal-header">
                <h5 class="modal-title" id="multipleDueDateLabel">Multiple Due Date</h5>
              </div>
              <div class="modal-body">
              
                <div class="col-sm-12 table-responsive">

                  {!! Form::open(['url' => route('invoice_due_date', $invoice->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_form', 'files' => 'true', 'enctype' => "multipart/form-data"]) !!}
                  ...
                  <table class="table appended_tr">
                    ...
                    <tbody>
                        ...
                        @foreach($invoice_due_dates as $date_value)
                             <tr>
                            <td>
                              <div class="form-inline">
                                <input class="form-control date" type="date" name="0[]" value="{{ $date_value->date }}"  required="required">
                              </div>
                            </td>
                            <td>
                               <input class="form-control amount" type="text" name="1[]" value="{{ $date_value->amount }}" required="required"/>
                            </td>
                            <td>
                               <a href=""><i class="material-icons md-36 remove_field">delete</i></a>
                            </td>
                            <td>
                                <input class="hidden" name="total" id="total" value="{{ $invoice->total_amount }}">
                            </td>
                          </tr>
                        @endforeach
                      <tr>
                        ...
                        <td>
                          <div class="form-inline">
                            <input class="form-control date" type="date" name="0[]"  required="required">
                            {{-- <input class="form-control date" type="text" name="date[]"/> --}}
                          </div>
                        </td>
                        <td>
                           <input class="form-control amount" type="text" name="1[]" required="required"/>
                        </td>
                        <td>
                           <a href="" ><i class="material-icons md-36 add_more_data" >&#xE146;</i></a>
                        </td>
                        <td>
                            <input class="hidden" name="total" id="total" value="{{ $invoice->total_amount }}">
                        </td>
              ...
              <div style="border-top: none" class="modal-footer">
                <h3 style="text-align: center" id="totalAmount">Total : {{ $invoice->total_amount }}</h3><br>
...
@section('sweet_alert')
    ...
    <script type="text/javascript">
      ...
      $(".appended_tr").on("change", '.amount', function(){
            ...
            if (val > total) 
            {
              alert('Cant be greater than total amount');
            }
      });
