                                ...
                                <div class="uk-margin-top">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="customer_id" ng-model="customer_id" ng-change="getCustomerInvoice()">
                                        ...
                                        <div class="uk-width-medium-1-1">
                                            ...
                                            <table class="uk-table">
                                                ...
                                                <tr class="form_section" id="data_clone"  >
                                                    ...
                                                    <td>
                                                        <textarea type="text" id="description_0" class="md-input" name="description[0]" ng-model="description[0]"></textarea>
                                                    </td>
                                                    <td onkeyup="stockCheck(this)">
                                                        <input  type="text" id="quantity_0" name="quantity[0]" ng-init="quantity[0]='1'" ng-model="quantity[0]" ng-keyup="calculateInvoice()" class="md-input"/>
                                                ...
                                                <tr ng-repeat="invoice in invoices track by $index" class="form_section" id="data_clone">
                                                    ...
                                                    <td>
                                                        <textarea type="text" id="description_@{{ $index + 1 }}" class="md-input" name="description[]" ng-model="description[$index+1]"></textarea>
                                                    </td>
                                                    <td onkeyup="stockCheck(this)">
...
@section('scripts')
    ...
    <script>
        ...
        function stockCheck(tr){
          ...
          var sib=tr.previousElementSibling.previousElementSibling;
        ...
        function getStock(id,quant){
            $.ajax({
                url:"{!! route('ajax_show_item') !!}",
                method:"POST",
                data:{id: id,quantity:quant},
                success:function(response){
                    console.log(response);
                    $("#StockShow").text(response) ;
                }
