                                    ...
                                    <div class="uk-width-medium-1-1">
                                        <table class="uk-table">
                                            ...
                                            <tr ng-repeat="invoice_entry in invoice_entries track by $index" class="form_section" id="data_clone">
                                                ...
                                                <td>
                                                    <textarea type="text" id="description_@{{ $index }}" class="md-input" name="description[]" ng-model="description[$index]"></textarea>
                                                ...
                                                <td>
                                                    <div class="input-group uk-form-stacked">
                                                        ...
                                                        <span class="input-group-btn" style="font-size: 15px;">
                                                            <select class="input-group" id="discount_type_@{{ $index }}" name="discount_type[]" ng-model="discount_type" ng-change="calculateInvoice()" style="margin-top: 23px;border-bottom: none;border-left: none;border-top: none;margin-top: 3px;" required>
                         ...
                         {!! Form::close() !!}
                                ...
                                <!-- <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-3 uk-margin-medium-top">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-1">
                                                <label for="user_edit_uname_control">Adjustment Form: </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-width-medium-2-3">
                                        {!! Form::open(['url' => route('invoice_adjustment_update',['id' => $invoice->id]), 'method' => 'POST', 'files' => 'true']) !!}
                                        <table class="uk-table">
                                            <thead>
                                            <tr>
                                            ...
                                            <tr >
                                                <td>
                                                    <div class="input-group uk-form-stacked">
                                                        <input type="number" step="0.01" id="vat_adjustment" name="vat_adjustment"  class="md-input" value="{{ $invoice->vat_adjustment }}"/>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group uk-form-stacked">
                                                        <input type="number" step="0.01" id="tax_adjustment" name="tax_adjustment"  class="md-input" value="{{ $invoice->tax_adjustment }}" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group uk-form-stacked">
                                                        <input type="number" step="0.01" id="others_adjustment" name="others_adjustment"  class="md-input" value="{{ $invoice->others_adjustment }}" />
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        ...
                                        <div class="uk-width-1-1 uk-float-right">
                                            <input type="submit" id="submitStock" class="md-btn md-btn-primary" value="Update" name="submit" />
                                        </div>
                                        {!! Form::close() !!}
                                    </div>
                                </div> -->
