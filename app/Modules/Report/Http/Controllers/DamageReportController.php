...
class DamageReportController extends Controller
{
    public function index(){
        ...
        return view("report::damage.index",compact('OrganizationProfile','companys','products','start','end'));
    }
    ...
    public function filter(Request $request){
            ...
            if( $request->damage_type == 1 ) {
                ...
                $damage_items     = DamageItem::leftjoin('item','item.id','damage_items.item_id')
                                            ...
                                            ->selectRaw("   GROUP_CONCAT(item.company_id) as company_id, 
                                                            ...
                                                            damage_items.quantity as damaged,
                                                            damage_adjustment_entries.quantity as adjusted
                                            ")
        ...
        return view("report::damage.index",compact('OrganizationProfile','companys','alls','items','company_name','company_id','start','end','damage_type'));
    }
}
