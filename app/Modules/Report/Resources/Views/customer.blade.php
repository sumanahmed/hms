...
@section('title', 'Customer Report '.date("Y-m-d h-i-sa"))
                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b">Sales By Customer</p>
                                <p style="line-height: 5px; font-size: 12px;" >
                                    (This report include data from invoice, payment received, credit note refund. Total Received is sum of advance payment and invoice payment.)
                            ...
                            <div class="uk-width-1-1">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th class="uk-text-right">Total Balance</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @php
                                    ...
                                    <tr class="uk-table-middle">
                                        <td class="uk-text-left"><a href="{{route('report_account_customer_id',[$customerReportData['customer_id']])}}">{{$customerReportData['display_name']}}</a></td>

                                        <td class="uk-text-right">{{$customerReportData['total_sales']}}</td>
                                        <td class="uk-text-right">{{$customerReportData['total_receives'] + $customerReportData['total_excess_payment']}}</td>
                                        <td class="uk-text-right">{{ $customerReportData['total_refund'] }}</td>
                                        <td class="uk-text-right">{{ $customerReportData['total_sales'] - $customerReportData['total_receives'] - $customerReportData['total_excess_payment'] }}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="uk-table-middle">
                                        <td class="uk-text-right">Total <span style="color:darkred;font-size: 20px;">→</span></td>
                                        <td class="uk-text-right">{{ $total_sales }}</td>
                                        <td class="uk-text-right">{{ $total_receives + $total_excess_payment }}</td>
                                        <td class="uk-text-right">{{ $total_refund }}</td>
                                        <td class="uk-text-right">{{ $total_sales - $total_receives - $total_excess_payment }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
