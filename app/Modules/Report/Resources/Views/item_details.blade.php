                    ...
                    <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                        ...
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-small-5-5 uk-text-center">
                                ...
                                <p style="line-height: 5px;" class="heading_b">{{$item_report->item_name}} Report</p>
                            ...
                            <div class="uk-width-1-2">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-table-middle">
                                        ...
                                        <td class="uk-text-left">{{ $transaction }}</td>
                                        <td class="uk-text-left">{{ $customer }}</td>
                                        <td class="uk-text-right">{{ $rate }}</td>
                                        <td class="uk-text-right">{{ $stockData->mtotal }}</td>
                                        <td class="uk-text-right">{{ $bill_purchase }}</td>
                                    ...
                                    @endforeach
                                     <tr class="uk-table-middle">
                                        ...
                                        <td class="uk-text-right"> {{ $total_pur_quantity }}</td>
                                        <td class="uk-text-right"> {{ $total_purchase }}</td>
                                    </tr>
                            ...
                            <div class="uk-width-1-2">
                                <table class="uk-table" style="margin-left: 5px;">
                                    ...
                                    <tr class="uk-table-middle">
                                        ...
                                        <td class="uk-text-right">{{$InvoiceEntryData->rate}}</td>
                                        <td class="uk-text-right">{{ $InvoiceEntryData->quantity}}</td>
                                        <td class="uk-text-right">{{ $InvoiceEntryData->amount * $InvoiceEntryData->quantity }}</td>
                                        <?php
                                    ...
                                    @endforeach
                                     <tr class="uk-table-middle">
                                        ...
                                        <td></td>
                                        <td class="uk-text-right">Total</td>
                                        <td class="uk-text-right">{{ $total_sale_quantity }}</td>
