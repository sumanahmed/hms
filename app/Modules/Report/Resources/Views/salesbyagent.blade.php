...
@section('title', 'Sales Commission '.date("Y-m-d h-i-sa") )
                        ...
                        <div class="md-card-content invoice_content print_bg" style="height: 100%;">
                            ...
                            <div class="uk-grid" >
                                ...
                                <div class="uk-width-small-5-5 uk-text-center">
                                    ...
                                    <p style="line-height: 5px;" class="heading_b">Sales Commission</p>
                                ...
                                <div class="uk-width-1-1">
                                    <table class="uk-table">
                                        ...
                                        <tr class="uk-text-upper">
                                            ...
                                            <th class="uk-text-center">Total Payable (Debit)</th>
                                            <th class="uk-text-center">Total Paid (Credit)</th>
                                        ...
                                        <tbody>
                                         ...
                                         @foreach($journal as $item)
                                             <tr>
                                                 <td class="uk-text-left" style="word-wrap: break-word;"><a href="{{ route('report_Sales_by_agent_details',array('id'=>$item->agents_id,'start'=>$start,'end'=>$end)) }}" >{{ isset($item->agent_name)?$item->agent_name:'' }}</a> </td>
                                                 <td class="uk-text-center">{{ $item->totalinvoice }}</td>
                                                 <td class="uk-text-right">{{ number_format($item->sum, 2, '.', '') }}</td>
                                                 <td class="uk-text-right">{{ number_format($item->receivable, 2, '.', '') }}</td>
                                                 <td class="uk-text-right">{{ number_format($item->payable, 2, '.', '') }}</td>
                                                 <td class="uk-text-right">{{ number_format($Invoice->Paid($item->agents_id,$start,$end), 2, '.', '') }}</td>
                                                 <td class="uk-text-right">{{ number_format($item->payable - $Invoice->Paid($item->agents_id, $start, $end), 2, '.', '') }}</td>
                                             </tr>
                                         @endforeach
