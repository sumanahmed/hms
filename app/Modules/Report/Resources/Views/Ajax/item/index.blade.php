                                    ...
                                    <table id="contact_filter_table" class="uk-table">
                                        <thead>
                                          <tr class="uk-text-upper">
                                              <th class="uk-text-left">Category</th>
                                              <th class="uk-text-left">Contact Name</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        console.log(api_contact_details);

        window.onload = function () {

          api_contact_url = api_contact_url.replace(/&amp;/g, '&');

          console.log(api_contact_url);
          ...
          $.get(api_contact_url, function (Rcontactlist) {
            ...
            $('#contact_filter_table').DataTable({
                ...
                "columnDefs": [
                  ...
                  { className: "uk-text-right", "targets": [ 3 ] },
                  {
                      "targets": 1,
