                                        ...
                                        <div class="uk-width-medium-2-3">
                                            <table class="uk-table">
                                                ...
                                                <tr class="form_section">
                                                    ...
                                                    <td>
                                                        <input type="text" name="shipping_charge" ng-init="vat='0.00'" ng-model="vat" ng-change="calculateCreditNote()" class="md-input md-input-width-medium"  />
                                                    </td>
                                                    <td class="uk-text-right">
                                                        @{{ vat_show.toFixed(2) }}
                                                        <input type="hidden" name="tax_total" id="tax_total" value="@{{ vat_show.toFixed(2) }}"> 
                                                    </td>
                                                </tr>
                                                <tr class="form_section">
                                                    <td>
