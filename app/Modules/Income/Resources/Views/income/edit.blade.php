                            ...
                            <div class="uk-margin-top">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="Number"> {{ str_pad($income->income_number,6,'0',STR_PAD_LEFT) }} </label>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="customer_id" required>
                                            ...
                                            @foreach($customers as $customer)
                                                <option value="{{ $customer->id }}" {{ $customer->id == $income->customer_id ? "selected='selected'" : '' }} >{{ $customer->customer_id . " - " . $customer->display_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
