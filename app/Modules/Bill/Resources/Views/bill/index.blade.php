                    ...
                    <div class="md-card">
                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Purchase List</span></h2>
                            </div>
                        </div>
                        ...
                        <div class="user_content">
                                    ...
                                    @foreach($bills as $bill)
                                        <tr>
                                            ...
                                            <td class="uk-text-right" style="white-space:nowrap !important;">
                                                <a href="{{ route('purchase_invoice_show', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="View" class="material-icons">visibility</i></a>
                                                <a href="{{ route('purchase_invoice_edit', ['id' => $bill->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="material-icons">&#xE254;</i></a>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{{ route('purchase_invoice_create') }}" class="md-fab md-fab-accent branch-create">
