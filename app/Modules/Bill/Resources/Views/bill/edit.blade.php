                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update Purchase Invoice</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            {!! Form::open(['url' => route('purchase_invoice_update', $bill->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="bill_date" name="bill_date" value="{{ $bill->bill_date }}" data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="text" id="bill_number" name="bill_number" value="{{ "PINV-".$bill->bill_number }}" readonly/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="company_invoice" name="company_invoice" value="{{ $bill->company_invoice }}"/>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="form-control" title="Select Company" id="company_id" name="company_id" required>
                                            ...
                                            @foreach($company as $value)
                                                <option value="{{ $value->id }}" @if($bill->company_id == $value->id) selected @endif>{{ $value->serial." ".$value->company_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="uk-width-medium-1-1">
                                        <table class="uk-table">
                                            ...
                                            <tbody class="getMultipleRow">
                                                <?php $i=0; ?>
                                                @foreach($bill_entrys as $bill_entry)
                                                    <tr class="tr{{ $i }}">
                                                        <td>
                                                            <select name="item_id[]"  onchange="selectProduct({{ $i }})" class="getProductList md-input" id="item_id0">
                                                                @foreach($items as $item)
                                                                    <option value="{{ $item->id }}" @if($item->id == $bill_entry->item_id) selected @endif>{{ $item->item_name }}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="get_cartoon_size" id="get_cartoon_size0"></div>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input" name="rate[]" oninput="calculateActualAmount({{ $i }})" id="rate0" value="{{ $bill_entry->rate }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input" name="curtoon_size[]" oninput="calculateActualAmount({{ $i }})" id="curtoon_size0" value="{{ $bill_entry->curtoon_size }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input" name="quantity[]" oninput="calculateActualAmount({{ $i }}, 3)" id="quantity0" value="{{ $bill_entry->quantity }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input" name="undelivered_quantity[]" oninput="calculateActualAmount({{ $i }}, 0)" id="undelivered_quantity0" value="{{ $bill_entry->undelivered_quantity }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input" name="delivered_quantity[]" oninput="calculateActualAmount({{ $i }}, 1)" id="delivered_quantity0" value="{{ $bill_entry->delivered_quantity }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="md-input row_total" name="amount[]" oninput="calculateActualAmount({{ $i }}, 2)" id="row_total0" value="{{ $bill_entry->amount }}">
                                                        </td>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        <table class="uk-table">
                                            ...
                                            <tr>
                                                <td colspan="6"></td>
                                                <td>Total BDT</td>
                                                <td> <input type="text" class="md-input" name="total_amount" id="totalBdt" value="{{ $bill->amount }}" readonly></td>
                                            </tr>

                                            <tr>
                                                <td colspan="6"></td>
                                                <td>Unload Payment</td>
                                                <td> <input type="text" class="md-input" name="unload_payment" id="unloadPayment" value="{{ $bill->unload_payment }}"></td>
                                            </tr>

                                            <tr>
                                                <td colspan="6"></td>
                                                <td>Grand Total</td>
                                                <td> <input type="text" class="md-input" name="grand_total" id="grandTotal" value="{{ $bill->amount - $bill->unload_payment }}" readonly></td>
                                            </tr>

                                            <tr>
                                                <td colspan="6"></td>
                                                <td>Paid Amount</td>
                                                <td> <input type="text" class="md-input" name="paid_amount" id="paidAmount" value="{{ $bill->amount - ($bill->due_amount + $bill->unload_payment) }}"></td>
                                            </tr>

                                            <tr>
                                                <td colspan="6"></td>
                                                <td>Due Amount</td>
                                                <td> <input type="text" class="md-input" name="due_amount" id="dueAmount" value="{{ $bill->due_amount }}" readonly></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="due_date" name="due_date" value="{{ $bill->due_date }}" data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="due_date">Previous Image</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <img src="{{ asset($bill->image) }}" style="width:100px;height: 80px;"/>
                                    </div>
                                </div>

                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="image">New Image</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea class="md-input" name="note" id="note">{{ $bill->note }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" >
                                    ...
                                    <div class="uk-width-1-2" style="padding: 10px; height: 40px; position:relative;background: #2D2D2D ">
                                        <div id="inv" style="position: absolute; right: 10px; height: 40px; ">
                                            <input @if($journal_entrys) checked @endif type="checkbox" name="check_journal_entry" id="check_journal_entry" style=" margin-top: -1px; height: 25px; width: 20px;" />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="uk-grid uk-margin-large-bottom" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-1">
                                                <table class="uk-table">
                                                    ...
                                                    <tbody class="getRow">
                                                        <?php $i=0; ?>
                                                        @foreach($journal_entrys as $journal_entry)
                                                            <tr class="journal_tr_{{ $i }}">
                                                                <td>
                                                                    <select name="account_id[]"  onchange="selectAccount(0)" class="getJournalAccountList form-control" id="account_id_{{ $i }}">
                                                                        @foreach($accounts as $account)
                                                                            <option value="{{ $account->id }}" @if( $account->id == $journal_entry->account_name_id) selected @endif >{{ $account->account_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                                @if($journal_entry->debit_credit == 1)
                                                                    <td>
                                                                        <input type="text" class="md-input debit" name="debit[]" oninput="calculateJournal({{ $i }})" id="debit_{{ $i }}" value="{{ $journal_entry->amount }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="md-input credit" name="credit[]" oninput="calculateJournal({{ $i }})" id="credit_{{ $i }}" value="">
                                                                    </td>
                                                                @else
                                                                    <td>
                                                                        <input type="text" class="md-input debit" name="debit[]" oninput="calculateJournal({{ $i }})" id="debit_{{ $i }}" value="">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="md-input credit" name="credit[]" oninput="calculateJournal({{ $i }})" id="credit_{{ $i }}" value="{{ $journal_entry->amount }}">
                                                                    </td>
                                                                @endif
                                                                <td class="uk-text-right uk-text-middle">
                                                                    <span class="uk-input-group-addon">
                                                                        ...
                                                                        @else
                                                                            <a onclick="deleteJournalEntryRow({{ $i }})" ><i class="material-icons md-24">delete</i></a>
                                                                        @endif
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <tr>
                                                        <td>Total</td>
                                                        <td> <input type="text" class="md-input" id="totalDebit" value="{{ $total_debit }}" readonly></td>
                                                        <td> <input type="text" class="md-input" id="totalCredit" value="{{ $total_credit }}" readonly></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                ...
                                <div class="uk-grid" >
                                    ...
                                    <div class="uk-width-1-2" style="padding: 10px; height: 40px; position:relative;background: #2D2D2D ">
                                        <div id="inv" style="position: absolute; right: 10px; height: 40px; ">
                                            <input @if(!empty($free_entrys)) checked @endif type="checkbox" name="check_free_entry" id="check_free_entry" style=" margin-top: -1px; height: 25px; width: 20px;" />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="uk-width-medium-1-1">
                                                <table class="uk-table">
                                                    ...
                                                    <tbody class="getFreeEntryRow">
                                                        <?php $i = 0; ?>
                                                        @foreach($free_entrys as $free_entry)
                                                            <tr class="free_entry_tr_{{ $i }}">
                                                                <td>
                                                                    <select name="product_id[]" class="getFreeEntryList form-control" id="product_id_{{ $i }}" readonly>
                                                                       <option value="{{ $free_entry->product_id }}">{{ $free_entry->item_name }}</option>
                                                                    </select>
                                                                    <input type="hidden" name="bill_free_entry_id" value="{{ $free_entry->id }}" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="md-input" name="total_qty[]" oninput="calculateFreeEntry({{ $i }})" id="total_qty_{{ $i }}" value="{{ $free_entry->total_quantity }}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="md-input" name="received_qty[]" id="received_qty_{{ $i }}" value="{{ $free_entry->total_quantity - $free_entry->receivable_quantity }}" readonly>
                                                                </td>
                                                                <td class="uk-text-right uk-text-middle">
                                                                  <span class="uk-input-group-addon">
                                                                      @if($i == 0)
                                                                        <a class="add_free_entry_row"> <i class="material-icons md-24"></i> </a>
                                                                      @else
                                                                          <a onclick="deleteFreeEntryRow({{ $i }})"><i class="material-icons md-24">delete</i></a>
                                                                      @endif
                                                                  </span>
                                                                </td>
                                                            </tr>
                                ...
                                <div class="uk-grid uk-ma" data-uk-grid-margin @if(empty($journal_entrys)) id="submit" style="display: none;" @endif>
                ...
                if (quantity > 0 && item_id > 0) {
                    $.get('/purchase-invoice/ajax-free-item/' + item_id + '/' + quantity + '/' + bill_date, function (data) {
                        $('.getFreeEntryRow').append(
                            ...
                            '   </td>\n' +
                            '   <td>\n' +
                            '     <input type="text" class="md-input" name="received_qty[]" oninput="calculateFreeEntry(' + rowindex + ')" id="received_qty_' + rowindex + '" value="">\n' +
