            ...
            <div class="uk-grid uk-margin-large-top uk-margin-large-bottom" data-uk-grid-margin>
                <div class="uk-width-medium-1-1">
                    <table class="uk-table">
                        <thead>
                        <tr>
                            <th class="uk-text-nowrap">Payment Id</th>
                            <th class="uk-text-nowrap">Payment Date</th>
                            <th class="uk-text-nowrap">Amount</th>
                            <th class="uk-text-nowrap">Available</th>
                            <th class="uk-text-nowrap uk-width-medium-1-6">Amount to Use</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="excess_payment in excess_payments track by $index" class="form_section" id="data_clone">
                            <td>
                                <label>PM-@{{ excess_payment.pm_number }}</label>
                ...
                <div class="uk-width-medium-2-3">
                    <table class="uk-table">
                        ...
                        <tr class="form_section">
                            ...
                            <td>
                                <label id="due_balance" name="due_balance" ng-model="total_bill_due_amount">@{{ total_bill_due_amount }}</label>
                            </td>
                        </tr>
