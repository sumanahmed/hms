...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile"
        ...
        <div class="uk-width-large-10-10" ng-controller="ContactController">
            {!! Form::open(['url' => route('contact_update',['category_id'=>$category_id, 'id'=>$contact_id] ), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update @if($category_id == 1) Outlet @elseif($category_id == 2) Company @else Employee @endif</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="uk-margin-top">
                                ...
                                @if($category_id == 1)
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <input class="md-input" type="text" id="serial" name="serial" value="{{ $contact->serial }}" readonly/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="propietor" name="propietor"  value="{{ $contact->propietor }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="outlet" name="outlet"  value="{{ $contact->outlet }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <textarea class="md-input" name="address" id="address" cols="30" rows="4">{{ $contact->address }}</textarea>
                                            @if($errors->has('address'))
                                                <div class="uk-text-danger uk-margin-top">{{ $errors->first('address') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="company_id">Company</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <select name="company_id[]" id="selec_adv_1" multiple>
                                                @foreach($companys as $key=>$company)
                                                    <option value="{{ $company->id }}" @if(isset($selected_company[$key]) && $selected_company[$key]->company_id == $company->id) selected @endif >{{ $company->display_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="mobile" name="mobile"  value="{{ $contact->mobile }}"/>
                                ...
                                @if($category_id == 2)
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <textarea class="md-input" name="office_address" id="office_address" cols="30" rows="4">{{ $contact->office_address }}</textarea>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="office_phone" name="office_phone" value="{{ $contact->office_phone }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="rsm_mobile" name="rsm_mobile" value="{{ $contact->rsm_mobile }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="tsm_mobile" name="tsm_mobile" value="{{ $contact->tsm_mobile }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="sr_mobile" name="sr_mobile"  value="{{ $contact->sr_mobile }}"/>
                                ...
                                @if($category_id == 3)
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="employee_designation" name="employee_designation" value="{{ $contact->employee_designation }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <textarea class="md-input" name="employee_address" id="employee_address" cols="30" rows="4">{{ $contact->employee_address }}</textarea>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="employee_phone" name="employee_phone" value="{{ $contact->employee_phone }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="employee_nid" name="employee_nid" value="{{ $contact->employee_nid }}" />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="employee_reference" name="employee_reference"  value="{{ $contact->employee_reference }}"/>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="employee_mobile" name="employee_mobile"  value="{{ $contact->employee_mobile }}"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <textarea class="md-input" name="note" id="note" cols="30" rows="4">{{ $contact->note }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                       <img src="{{ asset($contact->image) }}" style="width:100px;height:80px;" />
                                    </div>
                                </div>
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
