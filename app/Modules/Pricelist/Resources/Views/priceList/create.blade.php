                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">@lang('trans.create_new_price_item')</span></h2>
                                </div>
                            </div>
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label for="contact" class="uk-vertical-align-middle">@lang('trans.contact_name')<span style="color: red;" class="asterisc">*</span></label>
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label for="item" class="uk-vertical-align-middle">@lang('trans.item_name')<span style="color: red;" class="asterisc">*</span></label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="sales_rate">@lang('trans.sale_rate')</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="sales_rate" id="sales_rate2">@lang('trans.sale_rate')</label>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="purchase_rate">@lang('trans.purchase_rate')</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="purchase_rate" id="purchase_rate2">@lang('trans.purchase_rate')</label>
