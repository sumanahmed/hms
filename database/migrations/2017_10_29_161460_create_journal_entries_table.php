...
class CreateJournalEntriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('journal_entries', function (Blueprint $table) {
            ...
            $table->integer('purchase_return_id')->nullable()->unsigned();
            $table->integer('damage_adjustment_id')->nullable()->unsigned();
            $table->integer('purchase_return_id')->nullable()->unsigned();
        ...
        Schema::table('journal_entries', function(Blueprint $table){
            ...
            $table->foreign('purchase_return_id')->references('id')->on('purchase_return')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('damage_adjustment_id')->references('id')->on('damage_adjustments')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('purchase_return_id')->references('id')->on('purchase_return')->onDelete('cascade')->onUpdate('cascade');
