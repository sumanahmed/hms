...
class CreateAccountTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('account', function (Blueprint $table) {
            ...
            $table->integer('pgl_account_type_id')->unsigned();
        ...
        Schema::table('account', function(Blueprint $table){
            ...
            $table->foreign('pgl_account_type_id')->references('id')->on('account_pgl')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('branch_id')->references('id')->on('branch')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('contact_id')->references('id')->on('contact')->onDelete('set null')->onUpdate('cascade');
