...
class CreatePmsPayslipsPaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pms_payslips_payments', function (Blueprint $table) {
            ...
            $table->integer('pms_advance_payment_id')->unsigned()->nullable();
            $table->integer('pms_expense_id')->unsigned()->nullable();
        ...
        Schema::table('pms_payslips_payments', function(Blueprint $table){
            ...
            $table->foreign('pms_advance_payment_id')->references('id')->on('pms_advance_payment')->onDelete('set null')->onUpdate('cascade');
