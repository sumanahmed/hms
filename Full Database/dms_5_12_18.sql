...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2018 at 02:27 PM
...
(2, 'Test 2', 'COM-000001', NULL, NULL, NULL, NULL, NULL, 'dhaka', '01525505050', '01525505050', '01525505050', '01525505050', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, 1, 2, 1, 1, 1, '2018-12-05 06:31:07', '2018-12-05 08:09:17', 2),
...
INSERT INTO `item` (`id`, `item_name`, `item_about`, `item_sales_rate`, `item_sales_account`, `item_sales_description`, `item_sales_tax`, `item_purchase_rate`, `item_purchase_account`, `item_purchase_description`, `reorder_point`, `barcode`, `item_image_url`, `total_purchases`, `total_sales`, `entry_date`, `product_code`, `curtoon_size`, `unit_type`, `image`, `note`, `item_category_id`, `item_sub_category_id`, `branch_id`, `created_by`, `updated_by`, `created_at`, `updated_at`, `company_id`) VALUES
(1, 'Toyota', NULL, '5000', NULL, NULL, NULL, '2000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '05-12-2018', 'SKU-000001', 10, 'pcs', 'uploads/images/product/1543990759.jpeg', '', NULL, NULL, 1, 1, 1, '2018-12-05 06:19:19', '2018-12-05 06:19:19', 2);
...
--
-- Table structure for table `outlet_roads`
--
...
--
-- Dumping data for table `outlet_roads`
--

INSERT INTO `outlet_roads` (`id`, `contact_id`, `contact_category_id`, `road_id`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
...
--
-- Indexes for table `outlet_roads`
--
ALTER TABLE `outlet_roads`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `outlet_roads`
--
ALTER TABLE `outlet_roads`
